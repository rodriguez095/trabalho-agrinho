...
Promover a conscientização sobre agricultura, meio ambiente e cidadania.
...
Sidebar com configurações (modo escuro).
Seções principais:
Introdução
Campo
Cidade (relação campo × cidade)
Inovação Digital / Tecnologia
Sustentabilidade
Interatividade (mini-jogo)
...
Observador de interseção (IntersectionObserver) para efeitos de visibilidade.
Mini-jogo da Fazenda 3x3 (principal atração):
Sistema de moedas.
Loja de sementes (Milho, Cenoura e Tomate) com preços diferentes.
Grid 3x3 interativo para plantar.
Tempos de crescimento variáveis por semente.
Modo Colheita.
Inventário de colheitas.
...
Menção às IAs utilizadas no desenvolvimento:
ChatGPT (geração de textos)
Claude (revisão e sugestões)
...
Foco em experiência do usuário (UX) através do jogo interativo.
Projeto autônomo (roda completamente no navegador).
Demonstra habilidades tanto de conteúdo quanto de programação front-end.
